...
impl EDC16U1Detector {
                        ...
                        if self.is_valid_soi_iq_axis(&iq_axis) {
                            ...
                            if valid_block {
                                ...
                                for dyn_idx in 0..max_dynamic_maps {
                                    ...
                                    // Max values can reach 1300 raw (30°) based on reference detection
                                    // We need:
    ...
    /// EDC16U1: Based on reference patterns analysis with CORRECT Big-Endian interpretation
    ...
    pub fn detect_maximum_vehicle_speed(&self, data: &[u8], detected_addresses: &HashSet<u32>) -> Vec<DetectedMap> {
        ...
        // Factor 0.01: raw value 25000 = 250 km/h displayed (same as the reference tool)
