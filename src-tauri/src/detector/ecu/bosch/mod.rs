...
pub mod map_maf_switch; // Switchs de la limitation de fumee des EDC16 (U1/U31/U34)
...
pub mod edc16c39;   // Bosch EDC16C39 (Fiat/Alfa Romeo Multijet)
...
pub use edc16c39::EDC16C39Detector;
