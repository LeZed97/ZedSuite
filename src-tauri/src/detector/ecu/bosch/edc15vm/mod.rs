...
impl EDC15VMDetector {
    ...
    /// 0xDD de 20 valeurs, conformément à la référence externe). L'ancienne
    ...
    fn name_known_maps(&self, data: &[u8], maps: Vec<DetectedMap>) -> Vec<DetectedMap> {
        ...
        for mut map in maps {
            ...
            if !named && map.size == 416 {
                ...
                // DD/DA 416 : la PLAGE de l'axe DA tranche (réf. externe
                ...
                // l'EGR (référence) — mais le stock_012GN n'a AUCUN DD/D9 et
            ...
            if !named && map.size == 4 && x_len == 2 && y_len == 1 {
                ...
                // la référence la trouve, EDCSuite non) ; c'est le CONTENU qui
